...
// NOTE: currently the scan function is a dummy placeholder that returns the sequence number of the snapshot it should scan
...
CreateTableFunctionInfo IcebergFunctions::GetIcebergScanFunction() {
    ...
    function_set.AddFunction(TableFunction( {LogicalType::VARCHAR}, IcebergScanFunction, IcebergScanBind, IcebergScanGlobalTableFunctionState::Init));
    function_set.AddFunction(TableFunction( {LogicalType::VARCHAR, LogicalType::UBIGINT}, IcebergScanFunction, IcebergScanBind, IcebergScanGlobalTableFunctionState::Init));
    function_set.AddFunction(TableFunction( {LogicalType::VARCHAR, LogicalType::TIMESTAMP}, IcebergScanFunction, IcebergScanBind, IcebergScanGlobalTableFunctionState::Init));

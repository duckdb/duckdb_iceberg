...
#ifndef CPX_FULL_HH_4221126370__H_
#define CPX_FULL_HH_4221126370__H_
...
namespace c {
struct cpx_full_json_Union__0__ {
private:
   size_t idx_;
   boost::any value_;
public:
   ...
   cpx_full_json_Union__0__();
};

struct cpx_full_json_Union__1__ {
private:
   size_t idx_;
   boost::any value_;
public:
   ...
   cpx_full_json_Union__1__();
};

struct cpx_full_json_Union__2__ {
private:
   size_t idx_;
   boost::any value_;
public:
   ...
   std::vector<uint8_t> get_bytes() const;
   void set_bytes(const std::vector<uint8_t>& v);
   cpx_full_json_Union__2__();
};

struct r508 {
   typedef cpx_full_json_Union__0__ contains_nan_t;
   typedef cpx_full_json_Union__1__ lower_bound_t;
   typedef cpx_full_json_Union__2__ upper_bound_t;
   bool contains_null;
...
struct cpx_full_json_Union__3__ {
private:
   size_t idx_;
   boost::any value_;
public:
   ...
   cpx_full_json_Union__3__();
};

struct manifest_file {
   typedef cpx_full_json_Union__3__ partitions_t;
...
inline
   bool cpx_full_json_Union__0__::get_bool() const {
   if (idx_ != 1) {
...
inline
   void cpx_full_json_Union__0__::set_bool(const bool& v) {
   idx_ = 1;
   value_ = v;
}

inline
   std::vector<uint8_t> cpx_full_json_Union__1__::get_bytes() const {
   if (idx_ != 1) {
	   throw avro::Exception("Invalid type for union");
   }
...
inline
   void cpx_full_json_Union__1__::set_bytes(const std::vector<uint8_t>& v) {
   idx_ = 1;
   value_ = v;
}

inline
   std::vector<uint8_t> cpx_full_json_Union__2__::get_bytes() const {
   if (idx_ != 1) {
	   throw avro::Exception("Invalid type for union");
   }
   return boost::any_cast<std::vector<uint8_t> >(value_);
...
inline
   void cpx_full_json_Union__2__::set_bytes(const std::vector<uint8_t>& v) {
   idx_ = 1;
   value_ = v;
}

inline
   std::vector<r508 > cpx_full_json_Union__3__::get_array() const {
   if (idx_ != 1) {
	   throw avro::Exception("Invalid type for union");
   }
...
inline
   void cpx_full_json_Union__3__::set_array(const std::vector<r508 >& v) {
   idx_ = 1;
   value_ = v;
}

inline cpx_full_json_Union__0__::cpx_full_json_Union__0__() : idx_(0) { }
inline cpx_full_json_Union__1__::cpx_full_json_Union__1__() : idx_(0) { }
inline cpx_full_json_Union__2__::cpx_full_json_Union__2__() : idx_(0) { }
inline cpx_full_json_Union__3__::cpx_full_json_Union__3__() : idx_(0) { }
}
namespace avro {
template<> struct codec_traits<c::cpx_full_json_Union__0__> {
   static void encode(Encoder& e, c::cpx_full_json_Union__0__ v) {
   ...
   static void decode(Decoder& d, c::cpx_full_json_Union__0__& v) {
...
template<> struct codec_traits<c::cpx_full_json_Union__1__> {
   static void encode(Encoder& e, c::cpx_full_json_Union__1__ v) {
	   e.encodeUnionIndex(v.idx());
	   switch (v.idx()) {
	   case 0:
		   e.encodeNull();
   ...
   static void decode(Decoder& d, c::cpx_full_json_Union__1__& v) {
	   size_t n = d.decodeUnionIndex();
	   if (n >= 2) { throw avro::Exception("Union index too big"); }
	   switch (n) {
	   case 0:
...
template<> struct codec_traits<c::cpx_full_json_Union__2__> {
   static void encode(Encoder& e, c::cpx_full_json_Union__2__ v) {
	   e.encodeUnionIndex(v.idx());
	   switch (v.idx()) {
	   case 0:
		   e.encodeNull();
   ...
   static void decode(Decoder& d, c::cpx_full_json_Union__2__& v) {
	   size_t n = d.decodeUnionIndex();
	   if (n >= 2) { throw avro::Exception("Union index too big"); }
	   switch (n) {
	   case 0:
...
template<> struct codec_traits<c::r508> {
   static void encode(Encoder& e, const c::r508& v) {
	   avro::encode(e, v.contains_null);
	   avro::encode(e, v.contains_nan);
	   avro::encode(e, v.lower_bound);
	   avro::encode(e, v.upper_bound);
   }
   static void decode(Decoder& d, c::r508& v) {
...
template<> struct codec_traits<c::cpx_full_json_Union__3__> {
   static void encode(Encoder& e, c::cpx_full_json_Union__3__ v) {
	   e.encodeUnionIndex(v.idx());
	   switch (v.idx()) {
	   case 0:
		   e.encodeNull();
   ...
   static void decode(Decoder& d, c::cpx_full_json_Union__3__& v) {
	   size_t n = d.decodeUnionIndex();
	   if (n >= 2) { throw avro::Exception("Union index too big"); }
	   switch (n) {
	   case 0:

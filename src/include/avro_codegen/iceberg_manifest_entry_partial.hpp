...
inline
const std::vector<k126_v127 >& manifest_entry_json_Union__0__::get_array() const {
    if (idx_ != 1) {
...
inline
std::vector<k126_v127 >& manifest_entry_json_Union__0__::get_array() {
    if (idx_ != 1) {
        throw avro::Exception("Invalid type for union manifest_entry_json_Union__0__");
    }
    return *boost::any_cast<std::vector<k126_v127 > >(&value_);
...
inline
void manifest_entry_json_Union__0__::set_array(const std::vector<k126_v127 >& v) {
    idx_ = 1;
    value_ = v;
}

inline
void manifest_entry_json_Union__0__::set_array(std::vector<k126_v127 >&& v) {
    idx_ = 1;
    value_ = std::move(v);
}

inline
const std::vector<k129_v130 >& manifest_entry_json_Union__1__::get_array() const {
    if (idx_ != 1) {
...
inline
std::vector<k129_v130 >& manifest_entry_json_Union__1__::get_array() {
    if (idx_ != 1) {
        throw avro::Exception("Invalid type for union manifest_entry_json_Union__1__");
    }
    return *boost::any_cast<std::vector<k129_v130 > >(&value_);
...
inline
void manifest_entry_json_Union__1__::set_array(const std::vector<k129_v130 >& v) {
    idx_ = 1;
    value_ = v;
}

inline
void manifest_entry_json_Union__1__::set_array(std::vector<k129_v130 >&& v) {
    idx_ = 1;
    value_ = std::move(v);
}
...
template<> struct codec_traits<manifest_entry_json_Union__0__> {
...
template<> struct codec_traits<manifest_entry_json_Union__1__> {
